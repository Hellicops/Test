...
public class Skills : MonoBehaviour
{
    ...
    void OnGUI()
    {
        if (_visable)
        {
            ...
            GUI.Label(new Rect(560, 180, 600, 800), "Speed", GUI.skin.GetStyle("Text"));     // Скорость
            ...
            GUI.Label(new Rect(900, 180, 600, 800), Speed.ToString(), GUI.skin.GetStyle("Text"));       // Скорость
            ...
            GUI.Label(new Rect(560, 460, 600, 800), "Speed:", GUI.skin.GetStyle("Text"));      // Скорость
            ...
            GUI.Label(new Rect(900, 460, 600, 800), CSpeed.ToString(), GUI.skin.GetStyle("Text"));      // Урон
